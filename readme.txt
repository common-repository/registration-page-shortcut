...
== Description ==
Why you need use this plugin: because the default regisration page of wordpress is too simple and It does not allow you to add more
information to introduce about your site, also if you want to customize a page where you can put more information to introduce about your site
or display more fields to collect more information from new user, this plugin is right choice for you It will help you to do that without have to modify wordpress core source code.
